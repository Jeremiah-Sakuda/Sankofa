          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="font-[family-name:var(--font-body)] text-[var(--muted)] text-sm mb-6">
                Sign in to save narratives to your library and access them from any device.
              </p>
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white text-gray-800 font-medium rounded-lg hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
              >
                {isLoading ? (
